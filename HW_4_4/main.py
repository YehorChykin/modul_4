# На сьогодні мій код не має в собі if __name__ == "__main__": - вже просто не встигаю і з самого початку не дочитав,
# що це потрібно. В цілому мені здалося що код працює виконуючи критерії оцінки. Напишіть мені, чи все ок і чи потрібно переробити на варінт з 
# if __name__ == "__main__": щоб в майбутньому імпортувати частини коду з інших файлів, дякую

import os

contacts_file_path = r"D:\Projects\start_python\modul_4\modul_4\HW_4_4\contacts.txt"
